package com.onlyhiedu.pro.IM.session;
...
import com.onlyhiedu.pro.IM.session.activity.MessageHistoryActivity;
import com.onlyhiedu.pro.IM.session.activity.MessageInfoActivity;
import com.onlyhiedu.pro.IM.session.extension.CustomAttachParser;
import com.onlyhiedu.pro.IM.session.extension.CustomAttachment;
...
import com.onlyhiedu.pro.IM.session.search.SearchMessageActivity;
import com.onlyhiedu.pro.IM.session.viewholder.MsgViewHolderAVChat;
import com.onlyhiedu.pro.IM.session.viewholder.MsgViewHolderDefCustom;
import com.onlyhiedu.pro.IM.session.viewholder.MsgViewHolderFile;
import com.onlyhiedu.pro.IM.session.viewholder.MsgViewHolderGuess;
import com.onlyhiedu.pro.IM.session.viewholder.MsgViewHolderRTS;
import com.onlyhiedu.pro.IM.session.viewholder.MsgViewHolderSnapChat;
import com.onlyhiedu.pro.IM.session.viewholder.MsgViewHolderSticker;
import com.onlyhiedu.pro.IM.session.viewholder.MsgViewHolderTip;
import com.onlyhiedu.pro.IM.team.TeamAVChatHelper;
