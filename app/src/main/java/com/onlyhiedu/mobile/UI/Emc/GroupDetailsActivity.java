        ...
        public View getView(final int position, View convertView, final ViewGroup parent) {
            ...
            if (fromCache == null) {
                ...
                if (TextUtils.isEmpty(fromCache.iconurl)) {
                    Glide.with(getContext()).load(R.drawable.ease_default_avatar).into(holder.imageView);

                } else {
                    Glide.with(getContext()).load(fromCache.iconurl).into(holder.imageView);
                }
                holder.textView.setText(fromCache.userName);
            }
