...
public class SmallClassFragment extends SimpleFragment implements TabLayout.OnTabSelectedListener {
    ...
    protected void initEventAndData() {
        ...
        mAdapter.addTab("待上课程", "SmallCourseFragment", SmallCourseFragment.class, null);
        mAdapter.addTab("完成课程", "SmallCourseRecordFragment", SmallCourseRecordFragment.class, null);
