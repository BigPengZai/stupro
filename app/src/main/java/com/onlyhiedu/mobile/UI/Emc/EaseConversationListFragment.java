...
import com.onlyhiedu.mobile.UI.Emc.base.EaseRxBaseFragment;
import com.onlyhiedu.mobile.UI.Emc.presenter.EaseConversationListPresenter;
import com.onlyhiedu.mobile.UI.Emc.presenter.contract.EaseConversationListContract;
import com.onlyhiedu.mobile.Widget.EaseConversationList;
...
public class EaseConversationListFragment extends EaseRxBaseFragment<EaseConversationListPresenter> implements EaseConversationListContract.View {
    ...
    @Override
    public void getIMUserFriendListSuccess(IMAllUserInfo contacts) {
        /*
        *   数据库表名为环信id
        *   查询数据库没有数据的时候，把服务端数据添加到本地
        *   添加好友的时候，把数据插入到本地数据库
        *
        */
    ...
    protected void initData() {
        ...
        List<IMUserInfo> all = UserCacheManager.getAll();
           /*
        *   数据库表名为环信id
        *   查询数据库没有数据的时候，把服务端数据添加到本地
        *   添加好友的时候，把数据插入到本地数据库
        ...
        */
        if (all == null || all.size() == 0) {
            mPresenter.getIMUserFriendList();
        } else {
            init();
        }
