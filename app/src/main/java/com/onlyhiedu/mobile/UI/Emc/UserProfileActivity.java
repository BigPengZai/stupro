 ...
 * 个人资料
 */
public class UserProfileActivity extends EaseRxBaseActivity<UploadAvatarPresenter> implements OnClickListener, UploadAvatarContract.View {
...
//		boolean enableUpdate = intent.getBooleanExtra("setting", false);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            case REQUESTCODE_PICK:
                ...
                mRealFilePath = UploadAvatarPresenter.getRealFilePath(this, data.getData());
                startPhotoZoom(data.getData());
                break;
            case REQUESTCODE_CUTTING:
                if (data != null) {
                    if (mRealFilePath != null) {
                        dialog = ProgressDialog.show(this, getString(R.string.dl_update_photo), getString(R.string.dl_waiting));
                        dialog.show();
                        mPresenter.uploadAvatar(new File(mRealFilePath));
                        Log.d(TAG, "mRealFilePath: "+mRealFilePath);
                    }
                    imgData = data;
                }
                break;
    ...
    @Override
    public void uploadAvatarSucess(Avatar avatarData) {
        if (avatarData != null && avatarData.imagePath != null) {
            Log.d("", avatarData.imagePath);
            asyncFetchUserInfo("asd");
            DemoHelper.getInstance().getUserProfileManager().uploadUserAvatar(avatarData.imagePath);
        }
