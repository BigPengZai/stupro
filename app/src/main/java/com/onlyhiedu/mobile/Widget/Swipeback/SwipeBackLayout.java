...
package com.onlyhiedu.mobile.Widget.Swipeback;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        try {
            boolean result = mDragHelper.shouldInterceptTouchEvent(event);
//        	System.out.println("swipelayout onintercept:" + result);
            return result;//mDragHelper.shouldInterceptTouchEvent(event);
